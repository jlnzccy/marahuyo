  ...
  return (
    <>
      ...
      <main id="main-content" className="pt-20 pb-24">
        <ReaderContainer>
          <p className="meta mb-4">a letter went missing</p>
          <h1 className="font-serif text-4xl font-bold leading-tight md:text-5xl">
            Couldn&rsquo;t open that <span className="font-italic italic font-normal">page</span>.
          </h1>
          <p className="mt-6 max-w-prose font-serif text-reading-sm text-muted text-pretty">
            The reader hit an error fetching this work. It may be a temporary network blip.
          </p>
